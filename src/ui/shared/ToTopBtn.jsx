...
const ToTopBtn = () => {
  ...
  return (
    <button
      ...
      } fixed right-5 bottom-5 sm:right-10 sm:bottom-6 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary-600 z-toTopBtn grid place-content-center hover:bg-opacity-75 focus:outline-hidden focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 dark:focus:ring-offset-gray-950 transition-all duration-300`}
    >
