...
const SidebarToggleButton = ({ isSidebarOpen, toggleSidebar }) => {
  return (
    <FloatingSpan className="lg:hidden !left-5 !top-5 z-mainBtns outline-none focus:ring-2 focus:ring-slate-600 transition-all duration-300 animate-slideRight">
