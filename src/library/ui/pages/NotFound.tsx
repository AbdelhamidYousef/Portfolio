  ...
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center px-6 bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        {/* 404 Number */}
        <h1 className="font-headlines font-black text-[clamp(8rem,25vw,14rem)] leading-none tracking-tight text-transparent bg-clip-text bg-linear-to-br from-primary-400 via-primary-600 to-primary-800 dark:from-primary-200 dark:via-primary-500 dark:to-primary-700 select-none animate-fade-up">
          404
        </h1>

        {/* Message */}
        <div className="mt-2 space-y-3 animate-fade-up [animation-delay:150ms] opacity-0 [animation-fill-mode:forwards]">
        ...
        {/* CTA */}
        <div className="mt-10 animate-fade-up [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
          <Link
            to="/"
        ...
        {/* Decorative element */}
        <div className="mt-16 flex justify-center gap-2 animate-fade-up [animation-delay:450ms] opacity-0 [animation-fill-mode:forwards]">
          {[...Array(3)].map((_, i) => (
            <span
              key={i}
